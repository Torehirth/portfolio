      ...
      <ul>
        <li>
          <a
            ...
            aria-label="LinkedIn"
          >
            <img src="./src/assets/icons/icons/linkedin.svg" alt="LinkedIn icon" loading="lazy" />
          </a>
        </li>
        <li>
          <a
        ...
        <li>
          ...
          >
            <img src="./src/assets/icons/icons/instagram.svg" alt="Instagram icon" loading="lazy" />
          </a>
        </li>
        <li>
          <a
            ...
            aria-label="Facebook"
          >
            <img src="./src/assets/icons/icons/facebook.svg" alt="Facebook icon" loading="lazy" />
          </a>
        </li>
      </ul>
    </nav>
...
//         >
//           <img src="./src/assets/icons/icons/Light-mode.svg" alt="Light mode icon" loading="lazy" />
//         </button>
//         <button id="dark-mode-btn" aria-label="Click for dark colour mode" title="Dark colour mode">
//           <img src="./src/assets/icons/icons/dark-mode.svg" alt="Dark mode icon" loading="lazy" />
//         </button>
//       </div>
//       {/* <!-- Hamburger button --> */}
